...
http://192.168.122.111/index.php?page=searchimg

## How to get flag
This page is supposed to show image's info depends on image's id.
```
http://192.168.122.111/index.php?page=searchimg&id=1&Submit=Submit#
```
...
## How to Fix
Don't construct queries with user-provided data. Use PDO instead if it is PHP. 
